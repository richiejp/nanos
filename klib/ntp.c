...
#define DEFAULT_MAX_FREQ_PPM 5000
...
badlimit:
        ...
        est_freq = fpclamp(est_off, -ntp.max_base_freq, ntp.max_base_freq);
        est_off = offset;
    } else {
        ntp.bad_regressions = 0;
    }
    ntp.est_offset = est_off;
    ntp.est_freq = est_freq;
    ntp.offset_sd = sd;
    ntp.skew = skew;
